package com.github.assemblathe1.cart.converters;

import com.github.assemblathe1.api.carts.CartDto;
import com.github.assemblathe1.api.carts.CartItemDto;
...
public class CartConverter {
    public CartDto modelToDto(Cart cart) {
        List<CartItemDto> cartItemDtos = cart.getItems().stream().map(it ->
                new CartItemDto(it.getProductId(), it.getProductTitle(), it.getPictureLink(), it.getQuantity(), it.getPricePerProduct(), it.getPrice())
